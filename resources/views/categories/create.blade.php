...
<body>
  ...
  <form method="POST" action="{{ route('category.store') }}" class=" col-9 bg-light" enctype="multipart/form-data">
    @csrf
      ...
      <div class="container h-50">
        <div class="row d-flex justify-content-center align-items-center h-10">
          <div class="col-xl-15">
            ...
            <h3 class="text-white mb-4 text-center">Thêm danh mục sản phẩm</h3>
  ...
  <script>
function more(){
        confirm("Bạn có chắc muốn thêm danh mục này không?")
    }
  </script>
</body>
