...
<body>
  <form method="POST" action="{{ route('blog.store') }}" class=" col-9 bg-light" enctype="multipart/form-data">
    @csrf
      ...
      <div class="container h-50">
        <div class="row d-flex justify-content-center align-items-center h-10">
          <div class="col-xl-15">
            ...
            <h3 class="text-white mb-4 text-center">Thêm tin tức</h3>
  ...
  <script>
function more(){
        confirm("Bạn có chắc muốn thêm tin tức này không?")
    }
  </script>
</body>
