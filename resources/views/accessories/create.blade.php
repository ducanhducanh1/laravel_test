...
<body>
  <form method="POST" action="{{ route('accessory.store') }}" class=" col-9 bg-light" enctype="multipart/form-data">
    @csrf
      ...
      <div class="container h-50">
        <div class="row d-flex justify-content-center align-items-center h-10">
          <div class="col-xl-15">
            ...
            <h3 class="text-white mb-4 text-center">Thêm phụ kiện</h3>
              ...
              <div class="card-body">
                ...
                <div class="row align-items-center d-inline-flex py-3">
                  ...
                  <div class="col-md-9 ps-5">
                    ...
                    <h6 class="mb-0">Danh mục phụ kiện</h6>
  ...
  <script>
function more(){
        confirm("Bạn có chắc muốn thêm phụ kiện này không?")
    }
  </script>
</body>
